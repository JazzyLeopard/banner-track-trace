...
const MaintenanceBanner = ({ className }: MaintenanceBannerProps) => {
  ...
  const bannerStyles = [
    "bg-red-100/80 border-2 border-red-300", // Red with darker red border
    "bg-amber-100/80 border-2 border-amber-300", // Amber with darker amber border
    "bg-sky-100/80 border-2 border-sky-300", // Sky blue with darker sky blue border
  ];
